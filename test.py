...
if __name__ == "__main__":
    ...
    i2c_bus = I2C(WEATHER_I2C_NUM, freq=WEATHER_I2C_FREQ_KHZ*1000,
                  scl=WEATHER_I2C_SCL, sda=WEATHER_I2C_SDA, gscl = fm.fpioa.GPIOHS26,
    ...
    while 1:
        time.sleep_ms(500)
        print(weather.qmc_read_xyz[0]) # QMC7983 read data
        list = weather.bme_values # BME280 read data
        print(list)
